...
using namespace std;
#ifdef _WIN32
#define CPP_FILE_PATH string("benchmark\\1_build_ellipse\\")
#else
...
pf::Information settings() {
	...
	// 其他功能
	inf.settings.details_settings.phi_incre_limit;
	inf.settings.details_settings.con_incre_limit;
	inf.settings.details_settings.OMP_thread_counts;
	// 文件输入输出
