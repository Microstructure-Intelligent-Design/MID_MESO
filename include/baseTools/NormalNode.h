...
namespace pf {
	...
	struct ChemEntry {
		int index;
		double value;
		double chemical_part;
		double elastic_part;
		double electric_part;
		double magnetic_part;
		double other_part;
		double laplacian;
		Vector3 gradient;
		ChemEntry() {
			this->index = 0;
			this->value = 0.0;
			this->chemical_part = 0.0;
			this->elastic_part = 0.0;
			this->electric_part = 0.0;
			this->magnetic_part = 0.0;
			this->other_part = 0.0;
			this->laplacian = 0.0;
		...
		ChemEntry& operator=(const ChemEntry& n) {
			this->index = n.index;
			this->value = n.value;
			this->chemical_part = n.chemical_part;
			this->elastic_part = n.elastic_part;
			this->electric_part = n.electric_part;
			this->magnetic_part = n.magnetic_part;
			this->other_part = n.other_part;
	...
	public:
		...
		vStrain       VirtualEigenStrains;                          ///< Storage for effective eigenstrains
