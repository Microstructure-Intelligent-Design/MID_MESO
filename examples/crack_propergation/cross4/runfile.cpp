...
int main(int argc, char* argv[]) {
	...
	///< main program
	{
		...
		for (int istep = set.begin_step; istep <= set.end_step; istep++) {
			...
			simulation.mechanics.Solve(2e-5, 1e7, 10000, false);
...
static double xi_ab(pf::PhaseNode& node, pf::PhaseEntry& alpha, pf::PhaseEntry& beta, pf::Info_DynamicCollection& inf) {
	return Gc(node, node[Grain1], inf) * 0.1552;
};
static double xi_abc(pf::PhaseNode& node, pf::PhaseEntry& alpha, pf::PhaseEntry& beta, pf::PhaseEntry& gamma, pf::Info_DynamicCollection& inf) {
	return Gc(node, node[Grain1], inf) * 3.0;
};
// < external functions
//！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！！
...
void settings() {
	// 方峙宣柊扮腎
	information.settings.disperse_settings.begin_step = 20000;
	information.settings.disperse_settings.end_step = 25000;
	information.settings.disperse_settings.int_width = 1.0 * 1e-6;  // for crack interface
	information.settings.disperse_settings.Nx = 100;
	information.settings.disperse_settings.Ny = 100;
	information.settings.disperse_settings.Nz = 1;
	information.settings.disperse_settings.y_bc = BoundaryCondition::ADIABATIC;
	information.settings.disperse_settings.x_bc = BoundaryCondition::ADIABATIC;
	...
	information.settings.file_settings.restart_datafile_path = CPP_FILE_PATH + "DATA_init_cross.dat";
	...
	information.settings.file_settings.dataFile_output_step = 500;
	// 可創悶狼協吶
	...
	information.materialSystem.mechanics.effectiveAppliedStrain[0] = 2e-4;
	...
	}
	{
		...
		geo.polyhedron.set_a_point_inside_polyhedron(0, 25, 0);
		geo.polyhedron.add_surf(pf::Point(0.0, 0.0, 0.0), pf::Point(50.0, 50.0, 0.0), pf::Point(0.0, 0.0, 1.0));
		information.nucleationBox.geometricRegion_box.push_back(geo);
	}
}